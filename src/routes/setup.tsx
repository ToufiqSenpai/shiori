...
import { downloadSpeechToTextModel, getSpeechToTextModels, setTextGenerationApiKey, SpeechToTextModelResult } from '../api/model';
...
export function ModelStep({ speechToTextModels }: ModelStepProps) {
  ...
  const { model: { speechToText: selectedSttModel }, setSpeechToTextModel } = useSettingsStore()
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setSpeechToTextModel(value as SpeechToTextModel)
            }
          >
            <SelectTrigger>
        ...
        <div className="space-y-2">
          <Label htmlFor="llmApiKey">
            {llmProviderLabel[llmProvider]} API Key
          </Label>
          <Input
            id="llmApiKey"
            type="password"
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span
                      className={cn(
                        'text-sm',
                        download.status === 'complete' && 'text-muted-foreground'
                      )}
                    >
                      {download.name}
                    </span>
